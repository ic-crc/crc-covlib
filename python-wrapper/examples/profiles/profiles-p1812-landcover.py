...
if __name__ == '__main__':
    ...
    csv_pathname = os.path.join(script_dir, 'profiles-p1812-landcover.csv')
    ...
    clutter_category_profile = csv_data['P1812 clutter category'].tolist()
    repr_clutter_height_profile = csv_data['P1812 representative clutter height (m)'].tolist()
